...
public class FunctionCallAlphabet {
    ...
    public static void main(String[] args) {
        ...
        i(24);    // pass it any integer and it will display a word beginning with I 
        ...
        n("NightMan");    // displays the word you pass it beginning with "N"
        ...
        t("Table");    // displays the word you pass it beginning with "T"
        u();    // returns the word to be displayed
        v( 1 );    // tell it how many times to display the word (1)
        w( 24 );    // pass it any integer and it will display a word beginning with W 
        x( 24 );    // returns a different word depending on what you pass it (1-2)
