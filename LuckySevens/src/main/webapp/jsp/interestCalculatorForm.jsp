<%-- 
    Document   : interestCalculatorForm
    Created on : Feb 14, 2015, 2:10:18 PM
    Author     : apprentice
--%>
    ...
    <body>
        <div class="container">
            ...
            <form action="calculateInterest" method="POST">
                <h3>How much money would you like to deposit?</h3>
                <input type="text" name="moneyDeposited">
                <h3>How many years would you like to invest?</h3>
                <input type="text" name="yearsInvested">
                <h3>How many times a year would you like to to compound interest? (Rate = 1.5%)</h3>
                <input type="text" name="timesCompounded">
